...
import rest_with_spring_boot_and_java.spring.unittest.mock.MockBook;
...
public class BookServiceTest {
    ...
    public void testFindAll() {
        ...
        assertEquals(new BigDecimal("25.0"), bookOne.getPrice());
        ...
        assertEquals(new BigDecimal("25.0"), bookFour.getPrice());
        ...
        assertEquals(new BigDecimal("25.0"), bookSeven.getPrice());
